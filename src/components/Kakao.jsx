...
import { starting_point } from "../data/startingPoints";
...
const Map = ({ locations }) => {
  ...
  const handleKFoodButton = () => {
    ...
    window.kfoodMarkers = [];
    locations
      .filter((location) => location.category === "kfood")
      .forEach((location) => {
        ...
        const nearestLocationName = findNearestLocation(
          currentPosition.lat,
          currentPosition.lng,
          starting_point
        );
  ...
  const handleJFoodButton = () => {
    ...
    window.jfoodMarkers = [];
    locations
      .filter((location) => location.category === "jfood")
      .forEach((location) => {
        const markerPosition = new kakao.maps.LatLng(
          location.latitude,
          location.longitude
  ...
  const handlefastFoodButton = () => {
    ...
    locations
      .filter((location) => location.category === "fastfood")
      .forEach((location) => {
        const markerPosition = new kakao.maps.LatLng(
          location.latitude,
          location.longitude
  ...
  const handleschoolFoodButton = () => {
    ...
    locations
      .filter((location) => location.category === "schoolfood")
      .forEach((location) => {
        const markerPosition = new kakao.maps.LatLng(
          location.latitude,
          location.longitude
  ...
  const handlewFoodButton = () => {
    ...
    window.wfoodMarkers = [];
    locations
      .filter((location) => location.category === "wfood")
      .forEach((location) => {
        const markerPosition = new kakao.maps.LatLng(
          location.latitude,
          location.longitude
  ...
  const handlecFoodButton = () => {
    ...
    window.cfoodMarkers = [];
    locations
      .filter((location) => location.category === "cfood")
      .forEach((location) => {
        const markerPosition = new kakao.maps.LatLng(
          location.latitude,
          location.longitude
      ...
      <div>
        {CategoryOpen && (
          <Category
            ...
            setMenu={setMenu}
            handleKFoodButton={handleKFoodButton}
            handleJFoodButton={handleJFoodButton}
            handleschoolFoodButton={handleschoolFoodButton}
            handlewFoodButton={handlewFoodButton}
            handlecFoodButton={handlecFoodButton}
            handlefastFoodButton={handlefastFoodButton}
          />
        )}
        {RListOpen && (
          <RestaurantList
